                      ...
                      {category.questions.map((question) => (
                        ...
                        >
                          ...
                          >
                            ...
                            <svg
                              className={`w-5 h-5 text-white/70 transition-transform duration-200 ${expandedQuestion === question.id
                                  ? "rotate-180"
                                  : ""
                                }`}
                              fill="none"
                          ...
                          <div
                            className={`overflow-hidden transition-all duration-300 ease-in-out ${expandedQuestion === question.id
